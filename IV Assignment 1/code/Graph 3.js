        ...
        var buffer_method_groups = d3.nest()
            ...
            .rollup(function (d) {
                return {
                    ...
                    avg_inefficiency: d3.mean(d, function (g) {
                        return g.inefficiency;
                    }),
                };
            })
            .entries(dataset);
...
function generate_plot(key, values) {
    ...
    y_max = d3.max(values, function (d) {
        return d.value.avg_inefficiency;
    })
    ...
    // draw a point g for each method
    ...
    point.append("circle")
        ...
        .attr("cy", function (d) {
            return y(d.value.avg_inefficiency);
        })
